...
class MealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meal" do
    assert_difference("Meal.count") do
      post meals_url, params: { meal: { date: @meal.date, name: @meal.name, user_id: @meal.user_id } }
    end
  ...
  test "should update meal" do
    patch meal_url(@meal), params: { meal: { date: @meal.date, name: @meal.name, user_id: @meal.user_id } }
